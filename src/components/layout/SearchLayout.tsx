  ...
  return (
    <div>
        <section className="mx-auto w-[90%] tablet:w-[80%] pc:w-[70%]">
            <div className="flex items-center p-5 bg-white/10 border border-[rgba(255,255,255,0.1)] rounded-[10px] mb-[35px]">
                ...
                <div className="flex justify-around w-[70%] text-center">
                    <div className="flex justify-center items-center flex-col gap-[5px]">
                        ...
                        <time className="block text-xs tablet:text-sm pc:text-base">2025-01-01</time>
                    </div>
                    <div className="flex justify-center items-center flex-col gap-[5px]">
            ...
            <div className="py-5 px-[30px] bg-white/10 border border-[rgba(255,255,255,0.1)] rounded-[10px]">
                <ul className="flex gap-[40px] font-bold">
                    <li className="cursor-pointer hover:text-green100 duration-300">공식경기</li>
                    <li className="cursor-pointer hover:text-green100 duration-300">한줄평가</li>
                </ul>
            </div>
        </section>
    </div>
