  ...
  return <div>
    <section className="searchArea mb-[30px] tablet:mb-[65px] pc:mb-[100px]">
        <div className="w-[80%] my-0 mx-auto tablet:w-[60%] pc:w-[40%]">
          ...
          <form action="" className="relative w-[100%] text-center">
            <img src="" alt="" className="absolute left-0 top-0"/>
            <input type="search" name="" placeholder="닉네임을 입력하세요." className="rounded-lg border-2 border-white w-[100%] focus:outline-none px-[60px] py-2 appearance-none"/>
          </form>
        </div>
    </section>
  </div>;
